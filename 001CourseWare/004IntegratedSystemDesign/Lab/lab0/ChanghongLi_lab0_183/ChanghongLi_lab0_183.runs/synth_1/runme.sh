...
HD_PWD='C:/000mygit/myeie/001CourseWare/004IntegratedSystemDesign/Lab/lab0/ChanghongLi_lab0_183/ChanghongLi_lab0_183.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab0_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab0_top.tcl
